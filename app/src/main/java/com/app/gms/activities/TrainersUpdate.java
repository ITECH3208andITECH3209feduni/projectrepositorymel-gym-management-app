...
public class TrainersUpdate extends AppCompatActivity {
    Button btnUpdate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trainers_update);
        bindViews();
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                delete();
                myref.child("Trainers").child(_name).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        Intent intent=new Intent(TrainersUpdate.this,AdminActivity.class);
    ...
    void delete()
    {
        ...
        Query query = ref.child("Trainers").orderByChild("name").equalTo(_name);
